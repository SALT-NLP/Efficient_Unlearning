...
class LoRAConfig(AdapterConfigBase):
    ...
    Args:
        ...
        use_gating (:obj:`bool`, optional):
            Place a trainable gating module besides the added parameter module to control module activation. This is
            e.g. used for PEFT. Defaults to False. Note that modules with use_gating=True cannot be merged using
            `merge_adapter()`.
    """
...
class PEFTConfig(ConfigUnion):
    """
    The PEFT adapter architecture proposed by Mao et al. (2022). See https://arxiv.org/pdf/2110.07577.pdf.
    """
